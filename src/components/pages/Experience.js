    ...
    <section className="bg-white p-8 mx-auto max-w-[1024px]">
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4">July 2023 - October 2023</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
